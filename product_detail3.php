    ...
    <section class="container sproduct my-5 pt-5">
        <div class="row mt-5">
            <div class="col-lg-4 col-md-12 col-5">
                <img class="img-fluid w-100 pb-1" src="./image/sports3.jpg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="./image/sports3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="./image/sports3.jpg" width="100%" class="small-img" alt="">
                    </div>
