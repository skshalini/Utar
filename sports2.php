    ...
    <div class="flex-container">
        <sectoin class="header">
            ...
            <div class="navigate-btn">
                <li><a href="buyer_home.php">Home</a>
                </li>
                <li><a href="sell.php">Sell</a></li>
                <li><a href="buyer_home.php">Go Back-</a></li>
            </div>
        </sectoin>
    </div>
    <section id="cart-item" class="pt-5 mt-5 container">
        <h2 class="font-weight-bold pt-5">Sports</h2>
        <hr>
    </section>
        ...
        <table width="100%">
            ...
            <tbody>
                ...
                <form method="post" action="add.php">
                    <td><button type="submit" name="foot-boll">Add</button></td>
                </form>
                ...
                <tr>
                <form method="post" action="add.php">
                    <td><button type="submit" name="sports_shoes">Add</button></td>
                </form>
