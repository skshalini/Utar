...
<div class="login-page">      
  ...
  <h1>Login</h1>
    ...
    <form class="login-form" method="post" action="seller_login.php" >

      <input type="text" name="email" placeholder="Email"required title="Ex- abc@gmail.com"/>
      <input type="password" name="password" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title=" Must contain atleast one number and one uppercase and lowercase letter,and atleast 8 or more characters"/>
     
      <button type="submit" name="seller_login_submit">Login</button>
      
      <p class="message">New member? <a href="seller_reg.php">Sign Up</a></p>
